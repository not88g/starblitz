...
function _update()
  ...
  elseif game_state == "play" then
    -- オひオのオまオへオふオやオまオふ カ🐱オゆオめカ😐オむオゆ カ▒カ🐱カ█オふオめオむオぬオもオま
    if btn(0) then player.x -= 2 end   -- ヌ●…
    if btn(1) then player.x += 2 end   -- ヌ●★
    if btn(2) then player.y -= 2 end   -- ヌ●➡️
    if btn(3) then player.y += 2 end   -- ヌ●⧗
    player.x = mid(0, player.x, 120)
    player.y = mid(0, player.y, 120)

    -- カ▒カ🐱カ█オふオめカ😐オねオぬ: z (btn 4), x (btn 5) オま オいオあオう
    shoot_cooldown += 1
    ...
    -- オゆオねオやオゆオのオめカ◆オふオも オよカ⬇️オめオま カ▒ オぬオやオまオもオぬカ●オまオふオみ t
    ...
    -- カ▒オよオぬオのオや オのカ█オぬオはオゆオの カ🐱オゆオめカ😐オむオゆ オよオゆ オゆオひオやオゆオもカ⬇️ オほオぬ カ█オぬオほ
...
function _draw()
  if game_state == "logo" then
    ...
    if game_state == "play" then
      ...
      -- オよカ⬇️オめオま カ▒ オぬオやオまオもオぬカ●オまオふオみ
      for b in all(bullets) do
        if b.t < 2 then
          pset(b.x, b.y, 8)      -- オむカ█オぬカ▒オやカ⬅️オみ オよオふカ█オのカ⬅️オみ オよオまオむカ▒オふオめカ😐
        else
          rectfill(b.x, b.y, b.x, b.y+1, 9)  -- 2 オゆカ█オぬオやオへオふオのカ⬅️カ✽ オよオまオむカ▒オふオめカ◆
        end
      end
